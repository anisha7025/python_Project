...
class BhhsambSpider(scrapy.Spider):
    ...
    def parse_details(self, response):
        ...
        job_title = divs.xpath(
            "//div[@class='text-left medium-text mobile-text-center']/span[@class='big-text']/text()").get()
        ...
        email = divs.xpath(
            "//div[@class='text-left medium-text mobile-text-center']/a[@class='agent_email']/@href").get()
        ...
        description = response.xpath("//div[@class='col-sm-24']//following-sibling::p//text()").extract()
